...
_URL = REPOSITORY_PATH / "data" / "processed" / "mdace_icd9_inpatient_evidence_only"
_URLS = {
...
class MDACE_Inpatient_ICD9_EV_Config(datasets.BuilderConfig):
    ...
    def __init__(self, **kwargs):
        ...
        """
        super(MDACE_Inpatient_ICD9_EV_Config, self).__init__(**kwargs)


class MDACE_Inpatient_ICD9_EV(datasets.GeneratorBasedBuilder):
    ...
    BUILDER_CONFIGS = [
        MDACE_Inpatient_ICD9_EV_Config(
    ...
    def _info(self):
        return datasets.DatasetInfo(
            ...
            features=datasets.Features(
                {
                    "evidence_id": datasets.Value("int64"),
